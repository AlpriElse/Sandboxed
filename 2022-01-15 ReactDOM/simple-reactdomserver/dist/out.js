  ...
  "node_modules/react-dom/cjs/react-dom-server.node.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        function renderToNodeStream2(element, options) {
...
var Server = __toESM(require_server());
...
console.log(Server.renderToStaticMarkup(/* @__PURE__ */ React.createElement(Greet, null)));
console.log("renderToNodeStream ---");
var readable = Server.renderToNodeStream(/* @__PURE__ */ React.createElement(Greet, null));
